...
icon = Image.open("F:/GUVI/Projects/Phonepe_Pulse/phonepe-icon.png")
...
if selected == "Home":
    ...
    with col1 :
        ...
        st.markdown("### :violet[Technologies :] Github Cloning, Python, MySql, Pandas, Streamlit, Mysql-connector-python and Plotly.")
        st.markdown("### :violet[Overview :] In this streamlit web app you can visualize the phonepe pulse data and gain lot of insights on transactions, number of users, top 10 state, district, pincode and which brand has most number of users and so on. Bar charts, Pie charts and Geo map visualization are used to get some insights.")
        

    with col2 :
        Img2 = Image.open("F:/GUVI/Projects/Phonepe_Pulse/phonepe-5.jpg")
        st.image(Img2)
...
#TOP CHATS - Transactions
    if Type == "Transactions":
        ...
        with col1:
            ...
            mycursor.execute(f"select state, sum(Transaction_count) as Total_Transaction_Count, sum(Transaction_amount) as Total from agg_trans where year = {Year} and Quarter = {Quarter} group by state order by Total desc limit 10")
        ...
        with col3:
            ...
            mycursor.execute(f"select pincode, sum(Transaction_count) as Total_Transaction_Count, sum(Transaction_amount) as Total from top_trans where year = {Year} and Quarter = {Quarter} group by pincode order by Total desc limit 10")
...
#TOP CHARTS - USERS
    if Type == "Users":
        ...
        if Year == 2022 and Quarter in [2,3,4]:
            ...
            with col2:
                st.markdown("### :violet[District]")
                mycursor.execute((f"select district, sum(Registered_User) as Total_Users, avg(app_opens) as Total_Appopens from map_user where year = {Year} and quarter = {Quarter} group by district order by Total_Users desc limit 10"))
...
#Overall State Data - Transactions Amount
        with col1:
            ...
            df2 = pd.read_csv("F:/GUVI/Projects/Phonepe_Pulse/CSV/statenames.csv")
            df1.State = df2
...
if selected == "About":
    ...
    with col2:
        Img3 = Image.open("F:/GUVI/Projects/Phonepe_Pulse/PhonePe-7.jpg")
        st.image(Img3)
